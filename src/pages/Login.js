    ...
    try {
      ...
      if (result.success) {
        ...
        if (errorData.oauthOnly) {
          setErrors({ general: backendMessage, oauthOnly: true });
      ...
      <div className="min-h-screen flex flex-col lg:flex-row">
        ...
        <div className="lg:w-[42%] bg-gray-50 flex items-center justify-center p-6 lg:p-8 min-h-screen lg:min-h-0 transition-colors duration-200">
          <div className="w-full max-w-md">
            ...
            {/* Error Message */}
            {errors.general && (
              <div className={`mb-6 border rounded-lg p-4 ${errors.oauthOnly
                ...
                <div className="flex items-start">
                  ...
                  <div className="flex-1">
                    <p className={`text-sm ${errors.oauthOnly
                    ...
                    {/* Show Google sign-in button for OAuth-only accounts */}
                    {errors.oauthOnly && (
                      <div className="mt-3 pt-3 border-t border-blue-300">
                        <button
                          type="button"
                          onClick={handleGoogleOAuth}
                          className="w-full px-3 py-2 bg-blue-600 hover:bg-blue-700 text-white font-semibold rounded-lg transition-colors duration-200 flex items-center justify-center gap-2"
                        >
