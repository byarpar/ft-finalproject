 ...
 * 
 * Displays detailed information about a word including definitions,
 * examples, audio pronunciation, and related discussions.
 */
...
const WordDetail = () => {
  ...
  const loadRelatedWords = useCallback(async (currentWord) => {
    try {
  ...
  }, [id, loadRelatedWords, loadComments]);
  ...
  if (loading) {
    return (
      <PageLayout title="Loading Word - Lisu Dictionary" description="Loading word details">
        <div className="min-h-screen bg-gray-50 py-8">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            {/* Word Detail Skeleton */}
            <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6 mb-6">
              <SkeletonLoader variant="text" count={1} className="h-12 w-64 mb-4" />
              <SkeletonLoader variant="text" count={3} className="h-4 mb-4" />
              <SkeletonLoader variant="text" count={2} className="h-4" />
            </div>
                          ...
                          <div className="absolute right-0 mt-2 w-56 bg-white rounded-lg shadow-xl border border-gray-200 py-2 z-50">
                            <div className="py-1">
                              ...
                              <button
                                ...
                                className="flex items-center w-full px-4 py-2 text-sm text-red-600 hover:bg-red-50:bg-red-900/20"
                              >
            ...
            {mobileMenuOpen && user && (
              <div className="md:hidden absolute top-full left-0 right-0 bg-white/95 backdrop-blur-md border-b border-white/20 shadow-lg z-50">
                <div className="max-w-7xl mx-auto px-4 py-3 space-y-1">
                  <Link
                    to="/"
                    className="flex items-center gap-3 px-3 py-2 text-gray-900 hover:bg-teal-50:bg-teal-900/20 rounded-lg transition-colors"
                  ...
                  <Link
                    ...
                    onClick={() => setMobileMenuOpen(false)}
                  >
                    <ChartPieIcon className="w-4 h-4 text-teal-600" />
                  ...
                  <button
                    onClick={handleLogout}
                    className="flex items-center gap-3 w-full px-3 py-2 text-red-600 hover:bg-red-50:bg-red-900/20 rounded-lg transition-colors"
                  >
        ...
        <div className="bg-white border-b border-gray-200">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-3">
            <nav className="flex items-center text-sm text-gray-600">
              <Link to="/dictionary" className="hover:text-teal-600:text-teal-400 transition-colors">
                Dictionary
              </Link>
              <ChevronRightIcon className="w-4 h-4 mx-2" />
              <Link to={`/dictionary?q=${word.english_word?.charAt(0) || ''}`} className="hover:text-teal-600:text-teal-400 transition-colors">
                {word.english_word?.charAt(0).toUpperCase() || ''}
              </Link>
              <ChevronRightIcon className="w-4 h-4 mx-2" />
              <span className="text-gray-900 font-medium">{word.lisu_word}</span>
            </nav>
          </div>
        </div>
            ...
            <div className="lg:col-span-2 space-y-6">
              ...
              <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-8">
                <div className="flex items-start justify-between mb-6">
                  <div className="flex-1">
                    ...
                    <h1 className="text-6xl font-bold text-gray-900 mb-3" style={{ fontFamily: 'serif' }}>
                      {word.lisu_word}
                    </h1>
                    ...
                    {word.pronunciation_lisu && (
                      <div className="mb-4">
                        ...
                        <p className="text-sm text-gray-500 mt-1">IPA Transcription</p>
                      </div>
                    )}
                  ...
                  <div className="flex flex-col gap-2 ml-4">
                    <button
                      ...
                      className="p-3 bg-teal-50 hover:bg-teal-100:bg-teal-900/40 rounded-full transition-colors group"
                    ...
                    <button
                      ...
                      className="p-3 bg-gray-50 hover:bg-red-50:bg-red-900/20 rounded-full transition-colors"
                    ...
                    <button
                      onClick={shareWord}
                      className="p-3 bg-gray-50 hover:bg-gray-100:bg-gray-600 rounded-full transition-colors"
                      title="Share word"
                    >
              ...
              <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-8">
                ...
                <div className="space-y-4">
                  {word.meaning && (
                    <div className="bg-gradient-to-r from-blue-50 to-indigo-50 rounded-lg p-5 border-l-4 border-teal-500">
                ...
                <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-8">
                  ...
                  <div className="space-y-4">
                    {examples.slice(0, 3).map((example, idx) => (
                      <div key={idx} className="bg-gradient-to-r from-blue-50 to-indigo-50 rounded-lg p-5 border-l-4 border-teal-500">
                        <div className="flex items-start justify-between gap-3">
                          ...
                          <button
                            ...
                            className="p-2 hover:bg-white/50:bg-gray-700/50 rounded-full transition-colors flex-shrink-0"
                            title="Listen to example"
                          >
                            <SpeakerWaveIcon className="w-5 h-5 text-teal-600" />
                          </button>
                        </div>
                      </div>
                    ))}
                      ...
                      <div>
                        ...
                        <div className="flex flex-wrap gap-2">
                          {word.synonyms.map((synonym, idx) => (
                            <span
                              key={idx}
                              className="px-4 py-2 bg-green-50 text-green-800 border border-green-200 rounded-lg text-sm font-medium hover:bg-green-100:bg-green-900/30 transition-colors cursor-pointer"
                              onClick={() => {
                      ...
                      <div>
                        ...
                        <div className="flex flex-wrap gap-2">
                          {word.antonyms.map((antonym, idx) => (
                            <span
                              key={idx}
                              className="px-4 py-2 bg-red-50 text-red-800 border border-red-200 rounded-lg text-sm font-medium hover:bg-red-100:bg-red-900/30 transition-colors cursor-pointer"
                              onClick={() => {
              ...
              {word.etymology_origin && (
                <div className="bg-gradient-to-br from-amber-50 to-orange-50 rounded-xl border border-amber-200 p-8">
                  ...
                  <div className="space-y-3">
                    <div>
                      <h3 className="text-sm font-semibold text-amber-800 mb-2">Origin</h3>
                      <p className="text-base text-gray-700 leading-relaxed">
                        {word.etymology_origin}
                      </p>
                    </div>
                    {word.etymology_context && (
                      <div>
                        <h3 className="text-sm font-semibold text-amber-800 mb-2">Historical Context</h3>
              ...
              <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-8">
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                  <div className="text-center p-4 bg-blue-50 rounded-lg">
                    ...
                    <div className="text-sm text-gray-600 mt-1">Examples</div>
                  </div>
                  <div className="text-center p-4 bg-green-50 rounded-lg">
                    <div className="text-3xl font-bold text-green-600">
                      {word.synonyms ? word.synonyms.length : 0}
                    </div>
                    <div className="text-sm text-gray-600 mt-1">Synonyms</div>
                  </div>
                  <div className="text-center p-4 bg-red-50 rounded-lg">
                    <div className="text-3xl font-bold text-red-600">
                      {word.antonyms ? word.antonyms.length : 0}
                    </div>
                    <div className="text-sm text-gray-600 mt-1">Antonyms</div>
                  </div>
                  <div className="text-center p-4 bg-purple-50 rounded-lg">
                    <div className="text-3xl font-bold text-purple-600">
                      {relatedWords.length}
                    </div>
                    <div className="text-sm text-gray-600 mt-1">Related</div>
                  </div>
                </div>
              </div>
                ...
                <ul className="space-y-3 text-gray-700">
                  {word.part_of_speech && (
                    <li className="flex items-start gap-3">
                      <span className="text-teal-600 mt-1 text-xl">•</span>
                      <span>
                  ...
                  {word.frequency_score && (
                    <li className="flex items-start gap-3">
                      ...
                      <span>
                        ...
                        <span className={`ml-2 px-2 py-1 rounded text-sm ${word.frequency_score > 70 ? 'bg-green-100 text-green-800' :
                          word.frequency_score > 40 ? 'bg-yellow-100 text-yellow-800' :
                ...
                {user ? (
                  <div className="border-t border-gray-200 pt-6">
                    <textarea
                      ...
                      className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-teal-500 focus:border-teal-500 bg-white text-gray-900 resize-none"
                      rows="3"
                    />
                    <button
            ...
            <div className="space-y-6">
              ...
              <div className="bg-gradient-to-br from-teal-50 to-cyan-50 rounded-xl border border-teal-200 p-6">
                ...
                <div className="space-y-2">
                  <button className="w-full px-4 py-2 bg-white border border-gray-300 text-gray-700 rounded-lg hover:bg-gray-50:bg-gray-600 text-sm font-medium transition-colors text-left flex items-center gap-2">
              ...
              <div className="bg-gradient-to-br from-purple-50 to-pink-50 rounded-xl border border-purple-200 p-6">
                ...
                <Link
                  ...
                  className="text-sm font-medium text-purple-600 hover:text-purple-700:text-purple-300 flex items-center gap-1"
                >
