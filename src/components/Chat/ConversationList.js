...
const ConversationList = ({
  ...
  return (
    <div className="h-full w-full border-r border-gray-200 dark:border-gray-700 flex flex-col bg-white dark:bg-gray-800">
      {/* Header */}
      <div className="px-3 md:px-4 py-3 md:py-4 border-b border-gray-200 dark:border-gray-700 flex-shrink-0">
        ...
        <div className="relative">
          ...
          <input
            ...
            className="w-full pl-10 pr-4 py-2 md:py-2.5 text-sm border border-gray-200 dark:border-gray-700 rounded-full bg-gray-50 dark:bg-gray-900 text-gray-900 dark:text-gray-100 placeholder-gray-500 dark:placeholder-gray-400 focus:ring-2 focus:ring-teal-500 focus:border-teal-500 focus:bg-white dark:focus:bg-gray-800 transition-colors"
          />
        </div>
      </div>
              ...
              <>
                <button
                  ...
                  className={`w-full p-3 md:p-4 flex items-start space-x-3 transition-all relative group ${selectedConversation?.id === publicChannel.id
                      ? 'bg-gradient-to-r from-teal-50 to-blue-50 dark:from-teal-900/40 dark:to-blue-900/40'
                ...
                >
                  ...
                  <div className="relative flex-shrink-0">
                    <div className="w-11 h-11 md:w-12 md:h-12 rounded-full bg-gradient-to-br from-teal-500 via-blue-500 to-purple-600 flex items-center justify-center shadow-lg ring-2 ring-white dark:ring-gray-800">
                  ...
                  <div className="flex-1 min-w-0 text-left">
                    <div className="flex items-center justify-between mb-1">
                      <div className="flex items-center gap-2">
                        ...
                        <span className="px-2 py-0.5 text-xs font-semibold text-teal-600 dark:text-teal-400 bg-teal-100 dark:bg-teal-900/50 rounded-full">
                          Public
                        </span>
                      </div>
                    </div>
                    <p className="text-[13px] md:text-sm text-gray-600 dark:text-gray-400 truncate">
                      Chat with everyone in the community
                    </p>
                  </div>
                </button>
                <div className="border-b-2 border-gray-200 dark:border-gray-700 mx-3 my-2" />
              </>
            )}
                    ...
                    <div className="flex-1 min-w-0 text-left">
                      <div className="flex items-center justify-between mb-1">
                        ...
                        {conversation.last_message_at && (
                          <span className="text-xs md:text-sm text-gray-500 dark:text-gray-400 ml-2 flex-shrink-0">
                            {formatDistanceToNow(new Date(conversation.last_message_at), { addSuffix: true })}
                          </span>
                        )}
                      </div>
                      <div className="flex items-center justify-between">
                        <p className="text-[13px] md:text-sm text-gray-600 dark:text-gray-400 truncate flex-1">
                          {lastMessage ? (
                            <>
                            ...
                            <span className="italic text-gray-500 dark:text-gray-500">No messages yet</span>
                          )}
                        </p>
